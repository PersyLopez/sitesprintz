...
- Review: [STARTER-TEMPLATE-STANDARD.md](./STARTER-TEMPLATE-STANDARD.md) for requirements
- Check: [TEMPLATE-CHECKLIST.md](./TEMPLATE-CHECKLIST.md) for quick reference
- Status: [../features/QUICK_REFERENCE_STATUS.md](../features/QUICK_REFERENCE_STATUS.md)
