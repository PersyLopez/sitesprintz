...
Coding standards and technical guides.

| Document | Topic |
|----------|-------|
| [JS-STANDARDS.md](./JS-STANDARDS.md) | JavaScript conventions (required reading) |
| [TESTING.md](./TESTING.md) | Test conventions |
| [TDD-GUIDELINES.md](./TDD-GUIDELINES.md) | TDD workflow |
...
| [ERROR_RESPONSE_STANDARDIZATION_GUIDE.md](./ERROR_RESPONSE_STANDARDIZATION_GUIDE.md) | API error format |

**Maintaining docs**: Update these files in place. Do not create parallel guides — [../governance/AGENT_DOCUMENTATION_GUIDE.md](../governance/AGENT_DOCUMENTATION_GUIDE.md).
