...
test.describe('Public Showcase Gallery E2E Tests', () => {
  ...
  test.describe('Category Filtering', () => {
    test('should filter sites by category', async ({ page }) => {
      ...
      const restaurantBtn = page.locator('.category-btn:has-text("Restaurant")').first();
    ...
    test('should show all sites when "All" is clicked', async ({ page }) => {
      ...
      // Click "All" button
      const allBtn = page.locator('.category-btn:has-text("All")').first();
      await allBtn.click();
  ...
  test.describe('SEO Optimization', () => {
    test('should have proper page title', async ({ page }) => {
      ...
      expect(title).toContain('SiteSprintz');
    });
