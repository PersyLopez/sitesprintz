...
(function() {
  ...
  function resolveSocialHref(platform, value) {
  ...
  function initSocialMedia(config) {
    ...
    const socialIcons = {
      ...
      tiktok: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12.525 2.016A8.96 8.96 0 0016.8 6.3c1.86.07 3.64.67 5.2 1.7V12a9.4 9.4 0 01-5.2-1.55v6.83A6.73 6.73 0 1110.2 11.1v3.18a3.54 3.54 0 103.54 3.5V2.02h-1.215z"/></svg>`,
      maps: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5A2.5 2.5 0 1112 6.5a2.5 2.5 0 010 5z"/></svg>`,
      website: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm7.93 9h-3.17a15.4 15.4 0 00-1.12-5 8.03 8.03 0 014.29 5zM12 4.07c.7 1.06 1.3 2.9 1.64 4.93H10.36C10.7 6.97 11.3 5.13 12 4.07zM4.26 14a8.02 8.02 0 010-4h3.42a16.3 16.3 0 000 4H4.26zm.81 2h3.17a15.4 15.4 0 001.12 5 8.03 8.03 0 01-4.29-5zM12 19.93c-.7-1.06-1.3-2.9-1.64-4.93h3.28c-.34 2.03-.94 3.87-1.64 4.93zM14.34 14H9.66a14.4 14.4 0 010-4h4.68a14.4 14.4 0 010 4zm.11 7a15.4 15.4 0 001.12-5h3.17a8.03 8.03 0 01-4.29 5zM16.32 10h3.42a8.02 8.02 0 010 4h-3.42a16.3 16.3 0 000-4zM8.07 4.07A8.03 8.03 0 003.78 9h3.17a15.4 15.4 0 011.12-4.93z"/></svg>`,
    ...
    const displayOrder = ['facebook', 'instagram', 'whatsapp', 'tiktok', 'maps', 'website', 'linkedin', 'twitter', 'youtube'];
    const links = [];
    displayOrder.forEach((platform) => {
      const url = resolveSocialHref(platform, profiles[platform]);
